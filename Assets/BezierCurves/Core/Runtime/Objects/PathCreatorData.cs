...
//        public void Initialize(NodeNetCreator nodeNetCreator, int id, Vector3 centre, bool defaultIs2D)
//        {
...
//            _bezierPath = new BezierPath(nodeNetCreator, pathId, centre, false, space);
